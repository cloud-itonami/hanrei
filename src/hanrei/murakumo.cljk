...
(defn collection
  [name]
  (str "com.etzhayyim.hanrei." name))

(def cell-specs {
  :get {:legacy-cell "com-etzhayyim-hanrei-coverage-get"
     :phase :event
  ...
  :domain-knowledge {:legacy-cell "domain-knowledge"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :caserecord {:legacy-cell "com-etzhayyim-hanrei-caseRecord"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "caserecord")]
     :required-gates common-gates
     :trigger "manifest cell caserecord"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :collectionjob {:legacy-cell "com-etzhayyim-hanrei-collectionJob"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "collectionjob")]
     :required-gates common-gates
     :trigger "manifest cell collectionjob"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :jurisdiction {:legacy-cell "com-etzhayyim-hanrei-jurisdiction"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "jurisdiction")]
     :required-gates common-gates
     :trigger "manifest cell jurisdiction"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :egovlaw {:legacy-cell "com-etzhayyim-hanrei-egovLaw"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "egovlaw")]
     :required-gates common-gates
     :trigger "manifest cell egovlaw"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :hanreirecord {:legacy-cell "com-etzhayyim-hanrei-hanreiRecord"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "hanreirecord")]
     :required-gates common-gates
     :trigger "manifest cell hanreirecord"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :hanketsurecord {:legacy-cell "com-etzhayyim-hanrei-hanketsuRecord"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "hanketsurecord")]
     :required-gates common-gates
     :trigger "manifest cell hanketsurecord"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :citationedge {:legacy-cell "com-etzhayyim-hanrei-citationEdge"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "citationedge")]
     :required-gates common-gates
     :trigger "manifest cell citationedge"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
